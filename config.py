...
_C.TRAIN.DATA.PREPROCESS.COLOR_CHANNEL = ''  # Optional: 'R', 'G', or 'B' to use a single RGB channel
...
_C.VALID.DATA.PREPROCESS.COLOR_CHANNEL = ''  # Optional: 'R', 'G', or 'B'
...
_C.TEST.DATA.PREPROCESS.COLOR_CHANNEL = ''  # Optional: 'R', 'G', or 'B'
