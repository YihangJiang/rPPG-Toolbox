...
# DeepPhys pure rppg (infraorbital): train on PURE-IN, test on UBFC-rPPG-IN
# Use relative path from script location
script_dir = Path(__file__).parent.parent
args.config_file = str(script_dir / "configs" / "experiments" / "deepphys_pure_to_ubfc_rppg_in.yaml")
