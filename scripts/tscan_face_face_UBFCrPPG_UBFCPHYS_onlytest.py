...
args.config_file = str(project_root / "configs" / "infer_configs" / "UBFC-rPPG_UBFC-PHYS_TSCAN_BASIC.yaml")
...
# %%
print("Starting TSCAN face testing on UBFC-PHYS dataset (trained on UBFC-rPPG)...")
print("=" * 80)
