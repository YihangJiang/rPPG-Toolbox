...
# DeepPhys: train on PURE, test on UBFC-rPPG
args.config_file = str(project_root / "configs" / "experiments" / "deepphys_pure_to_ubfc_rppg.yaml")
...
# When DO_PREPROCESS is False, the loader checks that these paths exist:
print("=" * 80)
print("PATHS USED WHEN DO_PREPROCESS IS FALSE (preprocessed data must exist):")
print("=" * 80)
print("TRAIN:")
print(f"  CACHED_PATH:     {config.TRAIN.DATA.CACHED_PATH}")
print(f"  FILE_LIST_PATH: {config.TRAIN.DATA.FILE_LIST_PATH}")
print("VALID:")
print(f"  CACHED_PATH:     {config.VALID.DATA.CACHED_PATH}")
print(f"  FILE_LIST_PATH: {config.VALID.DATA.FILE_LIST_PATH}")
print("TEST:")
print(f"  CACHED_PATH:     {config.TEST.DATA.CACHED_PATH}")
print(f"  FILE_LIST_PATH: {config.TEST.DATA.FILE_LIST_PATH}")
print("=" * 80)
print()
