...
# EfficientPhys UBFC-rPPG -> UBFC-PHYS (only test)
# Use path relative to script location to avoid working directory issues
# (project_root already calculated above)
args.config_file = str(project_root / "configs" / "infer_configs" / "UBFC-rPPG_UBFC-PHYS_EFFICIENTPHYS.yaml")
...
# %%
print("Starting EfficientPhys face testing on UBFC-PHYS dataset (trained on UBFC-rPPG)...")
print("=" * 80)
