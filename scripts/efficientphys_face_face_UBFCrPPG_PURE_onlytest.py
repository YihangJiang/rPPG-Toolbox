...
args.config_file = "../configs/infer_configs/UBFC-rPPG_PURE_EFFICIENTPHYS_BASIC.yaml"
...
# %%
print("Starting EfficientPhys face testing on PURE dataset (trained on UBFC-rPPG)...")
print("=" * 80)
