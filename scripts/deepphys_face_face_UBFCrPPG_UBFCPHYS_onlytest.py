...
args.config_file = str(project_root / "configs" / "infer_configs" / "UBFC-rPPG_UBFC-PHYS_DEEPPHYS_BASIC.yaml")
...
# %%
print("Starting DeepPhys face testing on UBFC-PHYS dataset (trained on UBFC-rPPG)...")
print("=" * 80)
