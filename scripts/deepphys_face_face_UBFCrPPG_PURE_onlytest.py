...
args.config_file = str(project_root / "configs" / "infer_configs" / "UBFC-rPPG_PURE_DEEPPHYS_BASIC.yaml")
...
# %%
print("Starting DeepPhys face testing on PURE dataset (trained on UBFC-rPPG)...")
print("=" * 80)
