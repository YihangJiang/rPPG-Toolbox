...
# EfficientPhys rppg pure - using minimal hierarchical config
# Use path relative to script location to avoid working directory issues
# (project_root already calculated above)
args.config_file = str(project_root / "configs" / "experiments" / "efficientphys_ubfc_rppg_to_pure.yaml")
# baseline
