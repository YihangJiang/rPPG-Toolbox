...
# EfficientPhys rppg physc (infraorbital)
# Use relative path from script location
script_dir = Path(__file__).parent.parent
args.config_file = str(script_dir / "configs" / "experiments" / "efficientphys_ubfc_rppg_to_phys_in.yaml")
